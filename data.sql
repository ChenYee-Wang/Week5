...
CREATE TABLE `message` (
  ...
  `time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '留言時間',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
INSERT INTO `message` VALUES (1,1,'這遊戲太好玩啦，我把房子賣了現在在公園玩','2021-03-26 02:05:57'),(2,2,'輸入TK888，就送魔關羽','2021-03-26 02:05:57'),(3,3,'頂天立地，上山下海','2021-03-26 02:05:57');
...
-- Dump completed on 2021-03-27 10:47:13
